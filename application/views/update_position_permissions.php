<section class="no-padding-bottom">
  <div class="container-fluid">
    <div class="alert alert-danger">
        <strong class="text-danger">*Note: Changes in default permissions will take effect for upcoming users only and will not affect the old users.</strong>
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="block">
          ...
          <div class="table-responsive pt-3">
            <table class="table" data-id="<?php echo $user_type_id ?>">
                <thead>
                <tr>
            ...
            <button type="button" id="btnsubmit" data-id="<?php echo $user_type_id?>" class="btn btn-primary btn-lg btn-block mt-5">Submit</button>
          </div>
        </div>
      </div>
    </div>

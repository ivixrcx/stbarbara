      ...
      <div class="col-lg-12">
        ...
        <div class="block tab-content">
          ...
          <div class="d-flex pull-right">
              <a class="pr-2 pb-2 pt-2" href="stock/create_stock_in_view/<?php echo $warehouse_id ?>"><button class="btn btn-primary">Stock In</button></a>
              <a class="pr-2 pb-2 pt-2" href="stock/create_stock_out_view/<?php echo $warehouse_id ?>"><button class="btn btn-danger">Stock Out</button></a>
          </div>

      ...
      <div class="col-lg-12">
        <div class="block">
          <div class="d-flex">
            ...
            <a class="align-self-end pr-2 pb-2 pt-2" href="purchaseorder/create_purchase_order_item_view/<?php echo $purchase_order_id ?>"><button class="btn btn-primary">Add item</button></a>
          </div>

...
<table>
  <tr>
    ...
    <td><b>DATE:</b>&nbsp;&nbsp;<?php echo date('M d, Y', strtotime($purchase_order->prepared_date))?></td>
  ...
  <tr class="break"><td colspan="5"></td></tr>
  <tr class="borderless">
    <td colspan="4"><b>Requested by:</b>&nbsp;<?php echo ucwords($purchase_order->req_full_name) ?></td>
  ...
  <tr class="break"><td colspan="5"></td></tr>
  <tr class="borderless">
    <td colspan="4"><b>Approved by:</b>&nbsp;&nbsp; <?php echo ucwords($purchase_order->appr_full_name) ?></td>
